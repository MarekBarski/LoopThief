...
const buttons = [
  { label: "PLAY", left: 28, top: 48, width: 108, height: 45, active: true },
  ...
  { label: "STEP", left: 185, top: 224, width: 120, height: 45 },
] as const;
  ...
  return (
    <section className="relative h-full w-full">
      <p className="absolute left-0 top-0 text-[12px] uppercase tracking-[0.24em] text-zinc-400">
        PAD MODE: <span className="text-amber-400">PLAY</span>
      </p>
